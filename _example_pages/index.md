...
description: "Twenty-one runnable examples demonstrating cloud-native patterns in four language stacks — each with automated verification."
marker: "▶"
label: "Examples"
permalink: /examples/
order: 1
...
| # | Example | Demonstrates | Python | Spring Boot | Quarkus | .NET | Infra |
|---|---------|-------------|:------:|:-----------:|:-------:|:----:|-------|
...
| # | Example | Demonstrates | Python | Spring Boot | Quarkus | .NET | Infra |
|---|---------|-------------|:------:|:-----------:|:-------:|:----:|-------|
| 09 | [API Registry]({{ '/docs/09-api-registry/' | relative_url }}) | Apicurio schema registry, compatibility rules | n/a | n/a | n/a | n/a | Podman |
...
| 28 | [Newman API Testing]({{ '/docs/28-appendix-o-newman/' | relative_url }}) | Postman collection runner, schema validation, CI | n/a | n/a | n/a | n/a | Podman |
| 30 | [Blazor Server + SignalR]({{ '/docs/30-appendix-q-blazor-signalr/' | relative_url }}) | Real-time dashboard with SignalR circuit and Redis backplane | — | — | — | ✓ | Podman |

**Legend:** ✓ = available, — = not applicable (language-specific example), n/a = language-agnostic (no application code)
...
examples/
  ...
  NN-slug/
    ...
    spring-boot/
      compose.yaml
      Dockerfile / services  # Spring Boot application code
    quarkus/
      compose.yaml
      Dockerfile / services  # Quarkus 3.33 LTS (JDK 25) application code
    dotnet/
      compose.yaml
      Dockerfile / services  # ASP.NET Core (.NET 10) application code
```
