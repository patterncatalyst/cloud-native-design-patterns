...
description: "Twenty-one runnable examples demonstrating cloud-native patterns — each with automated verification."
marker: "▶"
label: "Examples"
permalink: /examples/
order: 1
...
| # | Example | Demonstrates | Python | Spring Boot | .NET | Infra |
|---|---------|-------------|:------:|:-----------:|:----:|-------|
...
| # | Example | Demonstrates | Python | Spring Boot | .NET | Infra |
|---|---------|-------------|:------:|:-----------:|:----:|-------|
| 09 | [API Registry]({{ '/docs/09-api-registry/' | relative_url }}) | Apicurio schema registry, compatibility rules | n/a | n/a | n/a | Podman |
...
| 28 | [Newman API Testing]({{ '/docs/28-appendix-o-newman/' | relative_url }}) | Postman collection runner, schema validation, CI | n/a | n/a | n/a | Podman |
