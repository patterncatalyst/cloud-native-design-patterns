"""examples/21-graceful-shutdown/cpp — Conan 2 recipe.

Drogon-based REST service demonstrating graceful shutdown with SIGTERM
handling, readiness flip, and in-flight request draining. Uses libpq
...
class GracefulShutdownConan(ConanFile):
