...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, RevenueResult> producerFactory() {
        Map<String, Object> props = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, RevenueResult> kafkaTemplate(ProducerFactory<String, RevenueResult> pf) {
