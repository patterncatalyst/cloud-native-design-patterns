...
const (
	...
	Inventory_GetStockBatch_FullMethodName = "/inventory.Inventory/GetStockBatch"
)
...
type InventoryClient interface {
	...
	GetStockBatch(ctx context.Context, in *GetStockBatchRequest, opts ...grpc.CallOption) (*GetStockBatchReply, error)
}
...
func (c *inventoryClient) GetStock(ctx context.Context, in *GetStockRequest, opts ...grpc.CallOption) (*GetStockReply, error) {
...
func (c *inventoryClient) GetStockBatch(ctx context.Context, in *GetStockBatchRequest, opts ...grpc.CallOption) (*GetStockBatchReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStockBatchReply)
	err := c.cc.Invoke(ctx, Inventory_GetStockBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServer interface {
	...
	GetStockBatch(context.Context, *GetStockBatchRequest) (*GetStockBatchReply, error)
...
func (UnimplementedInventoryServer) GetStock(context.Context, *GetStockRequest) (*GetStockReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStock not implemented")
}
func (UnimplementedInventoryServer) GetStockBatch(context.Context, *GetStockBatchRequest) (*GetStockBatchReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStockBatch not implemented")
}
...
func _Inventory_GetStockBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStockBatchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServer).GetStockBatch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Inventory_GetStockBatch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServer).GetStockBatch(ctx, req.(*GetStockBatchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Inventory_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStockBatch",
			Handler:    _Inventory_GetStockBatch_Handler,
		},
	},
